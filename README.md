...
The front-end of the application will consist of a modern UI to display and interact with results and a local database to store user information (such as preferences). The back-end of the application will consist of a web API, containing business logic and algorithms to integrate with and retrun top results from APIs such as google maps. 
